\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \node (result1) at (6.5,1.5) {\includegraphics[width=0.8cm,height=0.8cm]{./images/mod/raw_carrot_pie.png}};
            ...
            \node (result2) at (10.5,1.5) {\includegraphics[width=0.8cm,height=0.8cm]{./images/mod/carrot_pie.png}};
        \end{scope}
        \begin{scope}[xshift = 0.35cm, yshift = -0.35cm]
            ...
            \node (14sub) at (-1.5,0) [font=\scriptsize] {};
